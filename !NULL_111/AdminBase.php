...
{
	/**
	 * Метод, который пользователя на то, является ли он администратором
	 * @return boolean
	 */
	public static function checkAdmin()
	{
		...
		// Полчучаем информацию о текущем пользователе
		...
		// Иначе завершаем работу с сообщением об закрытии доступа
		die('Доступ закрыт');
	}
}